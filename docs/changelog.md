...
- BUGFIX: The plugin will now safely abort initialization if it detects an unsupported game version.
- UI: The Modern Camera settings button now automatically hides when the interface is minimized.
